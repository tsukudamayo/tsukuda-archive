...
plt.contour(X1, X2, Z_grid, colors='grey', linewidth=1, origin='lower')
...
plt.title('prejection by KPCA')
plt.xlabel('1st principal component in space included by $\phi$')
plt.ylabel('2nd component')

plt.subplot(2, 2, 4, aspect='equal')
plt.scatter(X_back[reds, 0], X_back[reds, 1], c='red', s=20, edgecolors='k')
